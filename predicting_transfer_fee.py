...
display_graphs(test_predictions, y_test, "ANN", "results_transfer_fee")
...
pyplot.savefig("results_transfer_fee/" + 'ANN' + "-loss-vs-epochs")
pyplot.show()
...
display_graphs(y_pred, y_test, "Random-Forest-regression", "results_transfer_fee")
# %%
"""
 > ##  Linear regression
"""
...
display_graphs(y_pred, y_test, "Linear-regression", "results_transfer_fee")
